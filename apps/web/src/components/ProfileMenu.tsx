...
// Two-letter avatar fallback when the user has no avatar image.  Prefer the
// first letter of each of the first two whitespace-delimited name parts; fall
// back to the email's first letter; final fallback is a dot so the avatar
