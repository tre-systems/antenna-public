  ...
  return (
    <header class="flex items-center justify-between gap-4 px-8 py-4 text-xs uppercase tracking-widest text-slate-400">
      ...
      <button
        type="button"
        onClick={onClose}
        class="rounded-md px-3 py-1 text-xs font-medium text-slate-300 transition-colors hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
