  ...
  return (
    ...
    >
      ...
      <div
        ...
        class="relative m-0 max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-y-auto rounded-t-2xl bg-white p-5 shadow-xl ring-1 ring-slate-900/10 sm:m-4 sm:rounded-2xl dark:bg-slate-900 dark:ring-white/10"
      >
