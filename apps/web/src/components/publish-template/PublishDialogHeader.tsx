  ...
  return (
    <div class="flex items-start justify-between gap-3">
      ...
      <button
        ...
        onClick={onClose}
        disabled={saving}
        class="rounded-md p-1 text-slate-400 transition-colors hover:bg-slate-900/[0.04] hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-400/40 disabled:opacity-60 dark:hover:bg-white/5 dark:hover:text-slate-200"
